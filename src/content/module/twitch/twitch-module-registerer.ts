import CopyEmoteModule from "module/twitch/copy-emote/copy-emote-module.tsx";
...
import ChatHighlightUserModule from "./chat-last-message/chat-highlight-user-module.tsx";
...
export default class TwitchModuleRegisterer extends ModuleRegisterer {
	getModules(
		...
		return [
			...
			new CopyEmoteModule(logger, eventEmitter, storageRepository, utilsRepository, apiRepository),
		];
	}
}
